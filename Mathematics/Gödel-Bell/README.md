...
**Canonical path:** `Mathematics/Gödel-Bell/` (also reachable via [`Muons/`](../Muons) symlink on Unix `git clone`)
...
## Lean 4 declarations verified (`certificate | Bell-Godel Lean4 verification.lean`)
...
## Wolfram witnesses verified (`certificate | Bell-Godel Wolfram verification.wl`)
