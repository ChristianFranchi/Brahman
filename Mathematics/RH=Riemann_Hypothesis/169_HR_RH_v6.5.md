...
| Axis | Parameter | Limit | Logic | Grows |
|:-----------------|:-----------------|:-----------|:-------------|:-----------|
| **E** Spectral | $N \to \infty$ | Eigenmodes | Heyting | Resolution |
| **D** Geometric | $\lambda \to \infty$ | Domain | Boolean | Extension |
| **C** Arithmetic | $S \to$ all primes | Primes | Conditional | Depth |
...
© 2026 Christian Franchi Viceré — CC BY-NC-ND 4.0\
DOI: [10.5281/zenodo.19546495](https://doi.org/10.5281/zenodo.19546495). For permissions contact the author on LinkedIn.
