#!/usr/bin/env python3
# ACTUAL VERSION TESTED ON macOS — Mac Mini M4, 16GB, April 7-9 2026
# Generated all cutting-plane certificates n=3..18
# Runtime: n=16 (15.8min), n=17 (1.9h), n=18 (35.7h)
import numpy as np, cvxpy as cp, time, os, sys, resource
from itertools import product

CERT = os.path.expanduser("~/ACTiVE_thruster/Grothendieck/certificates/cutting_plane")
